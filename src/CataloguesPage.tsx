...
export default function CataloguesPage({ onHome, onGames }: CataloguesPageProps) {
  ...
  return (
    <div className="min-h-screen min-w-[1180px] bg-[#effdf5] text-[#111] font-dm">
      <header className="sticky top-0 z-30 border-b border-[#dedede] bg-white">
        <div className="grid h-[69px] grid-cols-[1fr_auto_1fr] items-center px-[50px]">
          <div className="text-[13px] font-semibold">Give the gift of <em className="font-tny-caslon font-normal">The New Yorker.</em></div>
          <a className="col-start-2 block" href="/" onClick={(event) => { event.preventDefault(); onHome() }}><img className="block h-[38px] w-[136px] object-contain" src="https://www.newyorker.com/verso/static/thenewyorker-us/assets/logo.svg" alt="The New Yorker" /></a>
