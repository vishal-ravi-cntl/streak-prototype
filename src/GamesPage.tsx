  ...
  return (
    <div className="min-h-screen min-w-[1180px] bg-white text-[#111] font-dm">
      ...
      <main className="pb-24">
        <header className="h-[220px] px-[72px] pt-[19px] text-center" ref={titleRef}><h1 className="font-tny-irvin text-[50px] font-normal leading-none uppercase">Puzzles &amp; Games</h1></header>
